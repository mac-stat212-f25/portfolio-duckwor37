...
```{r}
#checking CRS for datasets 
st_crs(mn_cities)
st_crs(mn_water)
st_crs(mn_counties)

#transforming mn_counties to match
...
This function turns the colors into a scale that is seeable for color blind individuals making your data more accessable to more people. 
...
mn_counties_leaf |> 
    ...
    addCircles(data = mn_cities_leaf |> 
    filter(County %in% paste(c("Anoka", "Hennepin", "Ramsey", "Dakota", "Carver", "Washington", "Scott"), "County")), color = "#444444")
```
