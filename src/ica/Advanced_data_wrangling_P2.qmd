...
If you don't put in the double it gets an error because it is trying to read \U as a special reference that needs a hex code. 
...
str_subset(posts, "odd")
str_extract_all(posts, "alone")
str_replace_all(posts, "beautiful", "stunning")
str_remove_all(posts, "Abby")
```
