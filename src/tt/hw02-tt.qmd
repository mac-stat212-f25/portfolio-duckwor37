...
```{r alt.text = a table showing the average ranking of the 8 top ranked European passports. Germany has a mean rank of 2.2 coming in first, followed by Finland, then Denmark, then Sweden, then Italy, then Spain, then France and finally the UK with an average rank of 4.15.}
Best_passport |> 
  group_by(country) |> 
